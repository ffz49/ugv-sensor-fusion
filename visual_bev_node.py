...
class VisualBEVNode(Node):
    ...
    def cloud_callback(self, msg):
        ...
        # Extract X, Y, Z coordinates cleanly into a 2D Numpy matrix (N, 3)
        ...
        # Filter out points that are too high (sky) or outside the grid bounds
        ...
        # Initialize the Occupancy Grid array with -1 (Unknown)
        ...
        self.publish_grid(grid_data, msg.header.stamp)
